                ...
                <div class="card card-invoice">
                    <div class="card-body">
                        <div class="invoice-header">
                            <h1 class="invoice-title">{{ trans('SingleInvoices.single_service_invoice') }}</h1>
                            <div class="billed-from">
                                <h6>{{ trans('SingleInvoices.single_service_invoice') }}</h6>
                                <p>{{ trans('SingleInvoices.adress') }}<br>
                                    Tel No: +212611111111<br>
