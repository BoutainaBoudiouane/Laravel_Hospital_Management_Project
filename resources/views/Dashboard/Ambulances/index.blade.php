									...
									<table class="table text-md-nowrap" id="example1">
                                        ...
                                        @foreach($ambulances as $ambulance)
											<tr>
                                                ...
                                                <td>
												<div
                                            class="dot-label bg-{{$ambulance->is_available == 1 ? 'success':'danger'}} ml-1"></div>
													{{$ambulance->is_available == 1 ? 'مفعلة':'غير مفعلة'}}</td>
                                                <td>{{$ambulance->notes}}</td>
                                                <td>
                                                    <a href="{{route('Ambulance.edit',$ambulance->id)}}" class="btn btn-sm btn-primary"><i class="fas fa-edit"></i></a>
