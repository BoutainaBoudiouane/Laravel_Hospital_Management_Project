    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ trans('Receipt.title') }}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <a href="{{route('Receipt.create')}}" class="btn btn-primary" role="button" aria-pressed="true">
                            {{ trans('Receipt.add_new_receipt') }}
                        </a>
                    </div>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table text-md-nowrap" id="example1">
                            ...
                            <tr>
                                <th>#</th>
                                <th>{{ trans('Receipt.patient_name') }}</th>
                                <th>{{ trans('Receipt.amount') }}</th>
                                <th>{{ trans('Receipt.description') }}</th>
                                <th>{{ trans('Receipt.date_added') }}</th>
                                <th>{{ trans('Receipt.actions') }}</th>
                            </tr>
                            </thead>
                            <tbody>
                            @foreach($receipts as $receipt)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('Receipt.show',$receipt->id)}}" class="btn btn-success btn-sm" target="_blank" title="{{ trans('Receipt.print_receipt') }}">
