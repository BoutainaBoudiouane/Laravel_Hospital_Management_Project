...
<div class="main-header sticky side-header nav nav-item">
    <div class="container-fluid">
        ...
        <div class="responsive-logo">
                <a href="{{ url('/' . $page='index') }}"><img src="{{URL::asset('Dashboard/img/brand/logohospital3.png')}}" class="logo-1" alt="logo"></a>
                <a href="{{ url('/' . $page='index') }}"><img src="{{URL::asset('Dashboard/img/brand/logo_hospital.png')}}" class="logo-2" alt="logo"></a>
            </div>
